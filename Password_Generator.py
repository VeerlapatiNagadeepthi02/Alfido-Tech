...
def gen():
    ...
    uppercase='ABCDEFGHIJKLMNOPQRSTUVWXYZ'+lowercase+'0123456789'
...
sc1=StringVar('')
t1=Label(screen,text='Password Generator',font=('Arial',25),fg='red',background ="light green")
t1.place(x=140,y=0)
t2=Label(screen,text='password:',font=('Arial',14),background ="light green")
t2.place(x=145,y=90)

il=Entry(screen,font=('Arial',14),textvariable=sc1)
il.place(x=270,y=90)
t3=Label(screen,text='Length: ',font=('Arial',14),background ="light green")
t3.place(x=145,y=120)

t4=Label(screen,text='Strength:',font=('Arial',14),background ="light green")
